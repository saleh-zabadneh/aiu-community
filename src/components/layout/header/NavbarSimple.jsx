...
const SimpleFloatingNav = () => {
  return (
    <nav className="fixed left-[50%] top-8 flex w-fit -translate-x-[50%] items-center gap-6 rounded-lg border-[1px] p-2 text-sm text-neutral-500 bg-transparent backdrop-blur-md z-50">
      <Logo />

      <NavLink>Chatbot</NavLink>
      <NavLink>Chatrooms</NavLink>
      <NavLink>Faculties</NavLink>
      <NavLink>Ai Generator </NavLink>
      <NavLink>Services</NavLink>
      <NavLink>Dev Community</NavLink>
      <JoinButton />
    </nav>
  );
};
