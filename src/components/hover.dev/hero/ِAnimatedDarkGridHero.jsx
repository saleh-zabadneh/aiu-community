...
const Content = () => {
  return (
    <div className="relative z-20 flex flex-col items-center justify-center max-w-6xl px-4 py-24 mx-auto md:px-8 md:py-36">
      ...
      >
        Your Ultimate Learning Hub AIU Community !
      </motion.h1>
      <motion.p
        initial={{
          y: 25,
      ...
      >
        join the Ultimate AIU COMMUNITY and elevate your university experience
        Connect, learn, and grow with the power of AI and collaborative tools
