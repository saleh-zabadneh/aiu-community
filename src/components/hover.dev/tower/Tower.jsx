  ...
  return (
    <div className="col-span-1 h-[600px] lg:col-span-4 lg:h-[600px]">
      <Card>
        ...
        <p className="mb-2 text-2xl">Connect With Friends and Colleagues</p>
        <p className="mb-8 text-zinc-400">
          Share posts and thoughts or interact with others on the community,
          with the community newsfeed all students have free space to expand
          their social circle
        </p>
...
const MockupSideBar = () => (
  <div className="w-24 h-full p-2 border-r border-zinc-700 bg-zinc-900">
...
const MockupTopBar = () => (
  <div className="flex gap-1 p-2 border-b border-zinc-700 bg-zinc-950">
    <div className="bg-red-600 rounded-full size-2"></div>
    <div className="bg-yellow-600 rounded-full size-2"></div>
  ...
  return (
    <div className="relative w-full">
      <div className="relative z-0 w-full p-4">
        <div className="w-full pb-2 text-xs font-semibold uppercase border-b border-zinc-700 text-zinc-500">
          <span>User</span>
        </div>
        {users.map((u, i) => (
          <motion.div
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 top-1/4 bg-gradient-to-b from-zinc-950/0 via-zinc-950/90 to-zinc-950" />
    </div>
  );
};
