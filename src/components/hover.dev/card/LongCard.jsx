    ...
    <div className="col-span-2 h-fit sm:h-[209px]">
      <Card>
        <div className="relative z-20">
          ...
          <p className="mb-1.5 text-2xl">A Toxicity Free Envitonment</p>
          <p className="max-w-sm text-zinc-400">
            our platform features AI-driven toxicity detection ensuring a safe
            and repectful online environment by identiffying and mitgating
            harmful content in real-time.
          </p>
        </div>
        <div className="absolute top-0 bottom-0 right-0 z-10 w-48 bg-gradient-to-r from-zinc-950/0 to-zinc-950" />
        <SpinningLogos />
      </Card>
    </div>
  );
...
const SpinningLogos = () => {
  ...
  return (
    <div
      ...
      className="absolute top-0 right-0 z-0 grid rounded-full shadow-inner translate-x-1/3 place-content-center bg-blue-900/50"
    >
      <motion.div
        initial={{ rotate: 0 }}
        animate={{ rotate: 360 }}
        ...
        className="relative grid rounded-full shadow place-items-center"
      >
        {ICON_DATA.map((icon, idx) => {
          ...
          return (
            <motion.div
              ...
              animate={{ rotate: -360 }}
              transition={TRANSITION}
              className="absolute grid rounded-full shadow-lg place-content-center bg-gradient-to-br from-blue-500 to-blue-800 text-blue-50"
            >
              <icon.Icon
                style={{
