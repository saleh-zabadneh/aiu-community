...
import { FaFlask, FaLaravel, FaPython, FaReact } from "react-icons/fa";
import { SiFlutter, SiNextdotjs, SiTypescript } from "react-icons/si";

export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[500px] w-full max-w-[500rem] items-center justify-center overflow-hidden rounded-lg  md:shadow-xl">
...
const Icons = {
  laravel: () => {
    <FaLaravel width="100" height="100" />;
  },
  react: () => {
    <FaReact width="100" height="100" />;
  },
  flask: () => {
    <FaFlask width="100" height="100" />;
  },
  python: () => {
    <FaPython width="100" height="100" />;
  },
  flutter: () => {
    <SiFlutter width="100" height="100" />;
  },
  next: () => {
    <SiNextdotjs width="100" height="100" />;
  },
  typeScript: () => {
    <SiTypescript width="100" height="100" />;
  },
