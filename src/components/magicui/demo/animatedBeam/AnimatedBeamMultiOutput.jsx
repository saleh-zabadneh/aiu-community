...
export function AnimatedBeamMultipleOutputDemo({ className }) {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex flex-row items-stretch justify-between w-full h-full gap-10">
        ...
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <img src="/svg/model.svg" alt="model-image" />
          </Circle>
          <Circle ref={div2Ref}>
            <img src="/svg/github.svg" alt="model-image" />
          </Circle>
          <Circle ref={div3Ref}>
            <img src="/svg/stackoverflow.svg" alt="model-image" />
          </Circle>
          <Circle ref={div4Ref}>
            <img src="/svg/facebook.svg" alt="model-image" />
          </Circle>
          <Circle ref={div5Ref}>
            <img src="/svg/youtube.svg" alt="model-image" />
          </Circle>
        </div>
      </div>
