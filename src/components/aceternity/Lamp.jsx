...
import { SparklesTextDemo } from "../magicui/demo/sparklesTextDemo/SparklesTextDemo";
  ...
  return (
    <LampContainer>
      ...
      >
        <SparklesText
          text="Comming Soon"
          className2={"bg-gradient-to-r from-black to-slate-600 bg-clip-text"}
        />
        <br />
        <SparklesText
          className2={
            "bg-gradient-to-r from-slate-300 to-slate-600 bg-clip-text"
          }
          text="The Power of Lecture Generator and Vocie Cloning Generator"
        />
      </motion.h1>
    </LampContainer>
  );
